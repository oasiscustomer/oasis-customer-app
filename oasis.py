...
!pip install streamlit gspread oauth2client pytesseract opencv-python-headless Pillow numpy
...
if uploaded_image is not None:
    ...
    st.image(image, caption="업로드된 이미지", use_container_width=True)  # ✅ 최신 Streamlit 버전에 맞게 수정
