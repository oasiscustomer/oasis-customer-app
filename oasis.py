...
# oasis.py - 최종 안정화 버전 (KST 적용, 모든 오류 수정, 불필요한 텍스트 제거)
...
# 제목
st.markdown("""
    <h1 style='text-align: center; font-size: 28px;'>🚗 세차장 고객 관리 시스템</h1>
...
if matched:
    ...
    if new_plate and new_phone:
        ...
        already_exists_today = any(
            r.get("차량번호") == new_plate and today in str(r.get("방문기록", "")) for r in records
        )
