...
if input_number:
    ...
    if len(matched) == 1:
        ...
        worksheet.update_cell(row_index, 4, date_only)  # D열 = 마지막 방문날짜
worksheet.update_cell(row_index, 5, int(customer.get("총 방문 횟수", 0)) + 1)  # E열 = 총 방문 횟수
worksheet.update_cell(row_index, 6, new_log)  # F열 = 방문기록
