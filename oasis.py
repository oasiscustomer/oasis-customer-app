...
if search_button and plate_input:
    ...
    for r in records:
        car_num = r.get("차량번호")
        if isinstance(car_num, str) and (plate_input in car_num or car_num.endswith(plate_input)):
            matched.append(r)
...
if st.session_state.search_done:
    ...
    if matched and len(matched) == 1:
        ...
        options = [r['차량번호'] for r in matched if isinstance(r.get("차량번호"), str)]
