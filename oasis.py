...
if tesseract_path is None:
    print("🚨 경고: Tesseract 실행 파일을 찾을 수 없습니다. Streamlit Cloud 환경에서는 OCR 기능이 비활성화됩니다.")
    pytesseract.pytesseract.tesseract_cmd = None  # OCR 기능 비활성화
else:
    # Tesseract 실행 파일 경로 설정
    pytesseract.pytesseract.tesseract_cmd = tesseract_path
    print(f"✅ Tesseract가 정상적으로 설치되었습니다! 경로: {tesseract_path}")
