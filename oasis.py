...
if submit:
    st.session_state.input_plate = plate_input.strip()

records = worksheet.get_all_records()
matched = []

# ✅ 입력값이 있을 때만 검색 실행
if st.session_state.input_plate:
...
with st.form("register_form_always"):
    plate = st.text_input("🚘 전체 차량번호", value=st.session_state.new_plate_input, key="new_plate_input")
    phone = st.text_input("📞 고객 전화번호", value=st.session_state.new_phone_input, key="new_phone_input")
